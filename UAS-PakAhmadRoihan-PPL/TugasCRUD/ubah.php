...
<body style="background-color: #3498db;">
    <!-- Navbar -->
   <!-- Navbar -->
   <nav class="navbar navbar-expand-lg navbar-dark bg-gradient text-uppercase">
    <div class="container">
...
/* Background Gradien */
    ...
    .navbar-nav .nav-link:hover {
        color: #FFD700 !important; /* Warna kuning keemasan saat hover */
        transform: scale(1.1);
    }

    /* Gambar ikon navbar-toggler */
    .navbar-toggler-icon {
        background-image: url("data:image/svg+xml;charset=utf8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 30 30'%3E%3Cpath stroke='white' stroke-width='2' d='M4 7h22M4 15h22M4 23h22'/%3E%3C/svg%3E");
    }

    /* Styling untuk navbar pada perangkat mobile */
            ...
            <div class="col-md">
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control w-50" id="nim" value="<?= $siswa['nim']; ?>" name="nim" autocomplete="off" required >
                    </div>
                    <div class="mb-3">
